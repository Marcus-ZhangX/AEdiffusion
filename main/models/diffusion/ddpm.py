...
class DDPM(nn.Module):
    ...
    def get_posterior_mean_covariance(
        self, x_t, t, clip_denoised=True, cond=None, z_vae=None, guidance_weight=0.0  # z_vae参数sample函数外面传过来的
    ):
        B = x_t.size(0)
    ...
    def sample(
        ...
        x_t,
        cond=None,
        z_vae=None,  # z_vae参数sample函数外面传过来的
        n_steps=None,
        guidance_weight=0.0,
        checkpoints=[],
        ddpm_latents=None,
        ...
        for idx, t in enumerate(reversed(range(0, num_steps))):
            ...
            (
                ...
                x, t, cond=cond, z_vae=z_vae, guidance_weight=guidance_weight  # z_vae参数sample函数外面传过来的
            )
            nonzero_mask = (
