# python E:/Coding_path/DiffuseVAE/main/eval/ddpm/sample.py +dataset=celebamaskhq128/test \
...
#                         dataset.ddpm.evaluation.workers=1
 ...
 python E:/Coding_path/DiffuseVAE/main/eval/ddpm/sample_cond.py +dataset=celebamaskhq128/test \
#                         dataset.ddpm.data.norm=True \
#                         dataset.ddpm.model.attn_resolutions=\'16,\' \
