...
# # CelebAHQ-128 (Form1)
 python E:/Coding_path/DiffuseVAE/main/train_ddpm.py +dataset=celebamaskhq128/train \
#                      dataset.ddpm.data.root='/E:/Coding_path/DiffuseVAE/converted_TI_20000/' \   # 训练ddpm和训练vae使用的训练集是同一个
